...
// To move the hobbits to Rivendell, complete the travelAbroad function below. Write a loop (research the JavaScript forEach method) that goes through the shire array and using Javascript, unshift each hobbit into the new Rivendell array (docs: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/unshift). Have the function return the rivendell array, which should now contain all the hobbits!
